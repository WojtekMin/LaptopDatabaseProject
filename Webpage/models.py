...
class Laptop(models.Model):
    ...
    graphics_card = models.ForeignKey('GraphicsCard', on_delete=models.SET_NULL, null=True)
    storage_drive = models.ForeignKey('StorageDrive', on_delete=models.SET_NULL, null=True)
